...
if uploaded_file:
    ...
    for cls in selected_classes:
        classification, default_color = classification_styles.get(cls, ("Unknown", "yellow"))
        user_color = st.color_picker(f"Class {cls} ({classification})", default_color)
    ...
    if st.button("Generate Contour Map"):
        ...
        st.image(output_path, caption="Contour Output", use_column_width=True)
